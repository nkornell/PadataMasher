...
//   var pattern_para = /\n/g;
	...
	const min_highlight_length = 0
	html_out = remove_surrounding_tags(html_out,"ins",min_highlight_length)
	html_out = remove_surrounding_tags(html_out,"del",min_highlight_length)
	html_out = remove_surrounding_tags(html_out,"chg",min_highlight_length)


// 	var replacement = '';
// // 	html_out = "the <ins>go</ins>od people are <ins>c</ins>ool.";
// 	let result = html_out.match(/<ins>.{0,2}<\/ins>/gi);
// 	if (result != null) {
// 		for (i = 0; i < result.length; i++) {
// 			replacement = result[i].slice(5, result[i].indexOf('</ins>'));
// 			console.log(result[i]+ ' - ' + replacement);
// 			html_out = html_out.replace(result[i],replacement)
// 		}
// 	}
...
function remove_surrounding_tags(input_text, tag, max_length) {
...
// 	var return_text = "Hello <ins>no</ins> what are you <ins>yes</ins> doing yes"
	const removeStr = '<'+tag+'>.{0,'+max_length+'}<\/'+tag+'>';
